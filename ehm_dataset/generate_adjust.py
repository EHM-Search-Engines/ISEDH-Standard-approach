...
writer = csv.DictWriter(db_file3, fieldnames=fieldnames, lineterminator = '\n')
writer.writeheader()
...
for needleRoot, needleDirs, needleFiles in os.walk(NEEDLEPATH):
    # print('needleRoot', needleRoot)
    # print('needleRoot.split', needleRoot.split('/'))
